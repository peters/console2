...
typedef map<HTREEITEM, boost::shared_ptr<DlgSettingsBase> >	SettingsDlgsMap;
...
//		LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	private:
		...
		HTREEITEM AddDialogToTree(const wstring& strName, const boost::shared_ptr<DlgSettingsBase>& newDlg, CRect& rect, HTREEITEM htiParent = NULL);
